  ...
  return (
    <>
      <motion.div
        ...
        style={{ position: 'absolute', top: '0px', right: 0, backgroundColor: 'white', width: '100%', maxWidth: '400px', boxSizing: 'border-box', zIndex: 1000, maxHeight: '100vh', overflowY: 'auto' }}
      >
