  ...
  return (
    <>
      <motion.div
        ...
        style={{ position: 'absolute', top: '-25px', left: 0, backgroundColor: 'white', width: '80%', padding: '10px', boxSizing: 'border-box', zIndex: 1000, maxHeight: 'calc(100vh)', overflowY: 'auto' }}
      >
